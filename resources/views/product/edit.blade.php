...
<form action="{{ route('product.update', $row->id) }}{{ $tmp }}" method="post" name="form1" enctype="multipart/form-data">
  @csrf
  @method('PATCH')
  <table class="table table-sm table-bordered mymargin5">
    ...
    <tr>
      ...
      <td width="80%" align="left">
        <div class="d-inline-flex">
          <input type="text" name="pic" size="20" class="form-control form-control-sm">
        </div>
        <br><br>
        <b>파일이름</b> : {{ $row->pic }} <br>
        @if ($row->pic)
          <img src="{{ asset('/storage/product_img/' . $row->pic) }}" alt="" width="200" class="img-fluid img-thumbnail mymargin5">
        @else
          <img src="" alt="" width="200" height="150" class="img-fluid img-thumbnail mymargin5">
        @endif
      </td>
    </tr>
  </table>
