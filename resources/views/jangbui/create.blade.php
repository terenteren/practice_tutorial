...
<form action="{{ route('jangbui.store') }}{{ $tmp }}" method="post" name="form1">
  @csrf
  <table class="table table-sm table-bordered mymargin5">
    ...
    <tr>
      ...
      <td width="80%" align="left">
        <div class="d-inline-flex">
          <input type="text" name="numi" id="numi" size="20" maxlength="20" value="{{ old('numi') }}" class="form-control form-control-sm" onchange="cal_prices();">
        </div>
      </td>
    </tr>
    <tr>
