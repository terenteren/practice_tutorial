...
<form action="{{ route('jangbuo.store') }}{{ $tmp }}" method="post" name="form1">
  @csrf
  <table class="table table-sm table-bordered mymargin5">
    ...
    <tr>
      ...
      <td width="80%" align="left">
        <div class="d-inline-flex">
          <input type="text" name="price" id="price" size="20" maxlength="20" value="{{ old('price') }}" class="form-control form-control-sm" onchange="cal_prices();">
        </div>
        @error('price')
          {{ $message }}
        @enderror
    ...
    <tr>
      ...
      <td width="80%" align="left">
        <div class="d-inline-flex">
          <input type="text" name="numo" id="numo" size="20" maxlength="20" value="{{ old('numo') }}" class="form-control form-control-sm" onchange="cal_prices();">
        </div>
      </td>
    </tr>
    <tr>
      ...
      <td width="80%" align="left">
        <div class="d-inline-flex">
          <input type="text" name="prices" id="prices" size="20" maxlength="20" value="{{ old('prices') }}" class="form-control form-control-sm" readonly>
        </div>
      </td>
    </tr>
    <tr>
