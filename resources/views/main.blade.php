            ...
            <div class="container-fluid">
              ...
              <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                  <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="{{ route('jangbui.index') }}">매입</a>
                  </li>
                  <li class="nav-item">
                  ...
                  <li class="nav-item"><a href="{{ route('picture.index') }}" class="nav-link" href="{{ route('picture.index') }}">사진</a></li>
                </ul>
        ...
        <div id="carouselExampleIndicators" class="carousel slide">
          ...
          <div class="carousel-inner">
            <div class="carousel-item active">
              <img src="{{ asset('/my/img/main1.jpg') }}" height="150" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
              <img src="{{ asset('/my/img/main2.jpg') }}" height="150" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
              <img src="{{ asset('/my/img/main3.jpg') }}" height="150" class="d-block w-100" alt="...">
            </div>
          </div>
  ...
  <div class="modal-dialog modal-sm">
    <div class="modal-content">
      ...
      <div class="modal-body bg-light">
        <form action="{{ url('login/check') }}" name="form_login" method="post">
          @csrf
          <table class="table table-borderless mymargin5">
            ...
            <tr>
              <td width="30%"><h6>암&nbsp;호</h6></td>
              <td width="70%"><input type="password" name="pwd" class="form-control"></td>
            </tr>
          </table>
        </form>
      </div>
